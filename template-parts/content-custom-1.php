            ...
            <div class="content-product">
                <div class="row" style="margin: 0">
                    <?php while ($product_cate->have_posts()):$product_cate->the_post(); ?>
                        ...
                        <?php if ($i == 0): ?>
                            <div class="w-lg-40 col-md-4 col-sm-6 product-by-category product-by-category-one">
                                <a href="<?php echo get_permalink(); ?>"></a>
                                    <div class="feature-product-by-category">
                                        ...
                                        <div class="row d-none d-lg-flex">
                                            ...
                                            <div class="col-md-6">
                                                <a href="<?php echo get_permalink(); ?>"><p class="product-one-title"><?php echo the_title(); ?></p></a>
                        ...
                        <?php else: ?>
                            <a href="<?php echo get_permalink(); ?>">
                                <div class="w-lg-20 col-md-4 col-sm-6 product-by-category">
                                    <div class="feature-product-by-category">
                                        <img src="<?php echo $image[0]; ?>"
                                             data-id="<?php echo $deal_loop->post->ID; ?>">
                                        <?php if ($product->is_on_sale() && $product->is_type('simple')): ?>
